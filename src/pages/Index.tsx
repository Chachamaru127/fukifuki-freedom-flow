        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                  退職の悩み、
                  <br />
                  <span className="text-accent">プロが解決</span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/login">
                  <Button 
                    size="lg" 
                    className="bg-accent text-neutral-700 hover:bg-accent/90 text-lg px-8 py-4 h-auto"
                  >
                    無料で相談する
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-accent text-neutral-700 px-4 py-2 rounded-lg font-semibold shadow-lg">
                相談料0円
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl">確実性</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl">迅速対応</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section id="how-it-works" className="py-20 bg-neutral">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center relative">
              <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center text-neutral-700 font-bold text-xl mx-auto mb-6">
                2
              </div>
              <h3 className="text-xl font-semibold mb-4">お申し込み</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">退職完了</h3>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <Card key={index} className="p-6">
                ...
                <CardContent className="px-0">
                  <div className="flex items-start space-x-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-accent text-neutral-700 rounded-full flex items-center justify-center text-sm font-bold">
                      A
                    </span>
